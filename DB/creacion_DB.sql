...
CREATE TABLE IF NOT EXISTS `contabilidad`.`cuenta_bancaria` (
    ...
    CONSTRAINT `bnk` FOREIGN KEY (`id_banco`) REFERENCES `contabilidad`.`banco` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `contabilidad`.`layout` (
    ...
    CONSTRAINT `bnk_l` FOREIGN KEY (`id_banco`) REFERENCES `contabilidad`.`banco` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `contabilidad`.`transaccion_banco` (
    ...
    CONSTRAINT `cta_b` FOREIGN KEY (`id_cta`) REFERENCES `contabilidad`.`cuenta_bancaria` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `lyt` FOREIGN KEY (`id_layout`) REFERENCES `contabilidad`.`layout` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `contabilidad`.`dwh_mambu` (
    ...
    CONSTRAINT `rel_dwh` FOREIGN KEY (`id_dwh`) REFERENCES `contabilidad`.`transaccion_dwh` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `rel_mambu` FOREIGN KEY (`id_mambu`) REFERENCES `contabilidad`.`transaccion_mambu` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `contabilidad`.`transaccion_virtual` (
    ...
    CONSTRAINT `trn_b` FOREIGN KEY (`id_transaccion`) REFERENCES `contabilidad`.`transaccion_banco` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `contabilidad`.`contable_bancaria` (
    ...
    CONSTRAINT `cta_bnk` FOREIGN KEY (`id_bancaria`) REFERENCES `contabilidad`.`cuenta_bancaria` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `cta_cnt` FOREIGN KEY (`id_contable`) REFERENCES `contabilidad`.`cuenta_contable` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `contabilidad`.`banco_dwh` (
    ...
    CONSTRAINT `id_trn_bnk` FOREIGN KEY (`trn_banco`) REFERENCES `contabilidad`.`transaccion_banco` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `id_trn_dwh` FOREIGN KEY (`trn_dwh`) REFERENCES `contabilidad`.`transaccion_dwh` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `contabilidad`.`usuario` (
    ...
    CONSTRAINT `id_prf` FOREIGN KEY (`id_perfil`) REFERENCES `contabilidad`.`perfil` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `contabilidad`.`bitacora`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `contabilidad`.`bitacora` (
    `id` INT NOT NULL,
    `id_transaccion` INT NOT NULL,
    ...
    CONSTRAINT `id_trb` FOREIGN KEY (`id_transaccion`) REFERENCES `contabilidad`.`transaccion_banco` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `id_trd` FOREIGN KEY (`id_transaccion`) REFERENCES `contabilidad`.`transaccion_dwh` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `id_trm` FOREIGN KEY (`id_transaccion`) REFERENCES `contabilidad`.`transaccion_mambu` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `id_usr` FOREIGN KEY (`id_usuario`) REFERENCES `contabilidad`.`usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `contabilidad`.`sesion` (
    ...
    CONSTRAINT `id_usrs` FOREIGN KEY (`id_usuario`) REFERENCES `contabilidad`.`usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
